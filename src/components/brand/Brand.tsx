    ...
    <div className="mx-auto max-w-7xl p-6 font-sans">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div className="relative">
          <h2 className="text-3xl font-bold text-[#222222]">Our Special Brand Products</h2>
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        {/* Left Banner */}
        <div className="relative min-h-[400px]   overflow-hidden rounded-[20px] bg-[#FEF3D7] p-10">
          {/* Background Floral Pattern */}
          <div className="absolute bottom-4 left-4 h-48 w-48 opacity-10">
             <Image src="/floral-pattern.png" alt="" className="h-full w-full object-contain" fill  /> 
          </div>

          <div className="relative z-10 flex flex-col gap-4">
            <h1 className="max-w-[280px] text-4xl font-bold leading-tight text-[#222222]">
              Make Your Fashion Look More Changing
            </h1>
            <p className="text-lg text-gray-700">Get Off Selected Clothing Items</p>
          ...
          {/* Model Image */}
          <div className="absolute bottom-0 right-0 h-[90%] w-[55%]">
            <Image
              src={model} // Replace with your actual path
              alt="Fashion Model"
              fill
        ...
        <div className="grid flex-1 grid-cols-1 gap-4 sm:grid-cols-2">
          {products.slice(0, 8).map((product) => (
            <div
              key={product.id}
              className="flex items-center gap-4 rounded-2xl border border-gray-100 bg-white p-3 shadow-sm transition-hover hover:shadow-md"
            >
              {/* Product Image Wrapper */}
              <div className="h-24 w-24 flex-shrink-0 rounded-xl bg-[#F3F4F6] p-2">
                <Image
                  src={product.image}
                  height={80}
                  width={80}
              ...
              <div className="flex flex-col gap-1">
                <h3 className="line-clamp-1 text-[15px] font-semibold text-gray-800">
                  {product.title}
                </h3>
